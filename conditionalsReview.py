...
# # functions ahelp to wrap up code and define
...
#task: initial/final heights
initialheight = int(input("What is the initial height of the plant in cm? "))
week = int(input("What is the height of the plant after one week?"))

#task: Calculate Growth
growth = (week) - (initialheight)
print(initialheight)
print(week)
print(growth)